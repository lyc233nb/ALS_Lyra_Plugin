...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category = "ADS")
	bool bIsFiring = false;

	UFUNCTION(BlueprintCallable)
	void AddRecoilAnimation();
...
protected:
	...
	TObjectPtr<UBoxComponent> CollisionTriggerBox;


	UPROPERTY(BlueprintReadOnly, Category = "Collision", Transient)
	int32 OverlapCount = 0; 

	UPROPERTY(BlueprintReadWrite, Category = "Collision")
	TObjectPtr<AActor> CollidingActor;
